...
export const translations = {
  en: {
    ...
    skills: {
      ...
      expertise: {
        ...
        cleanCode: {
          ...
          description:
            "Writing maintainable, well-documented code that's easy to understand.",
        },
        uiux: {
          title: "UI/UX Mindset",
          description:
            "Attention to detail in design implementation and user experience.",
        },
        responsive: {
        ...
        performance: {
          title: "Performance",
          description:
            "Optimizing load times and ensuring smooth user experiences.",
        },
        problem: {
        ...
        debug: {
          ...
          description:
            "Quickly identifying and fixing bugs using modern tools.",
        },
        collab: {
          title: "Collaboration",
          description:
            "Working effectively with teams and communicating concepts clearly.",
        },
      },
    },
    projects: {
      heading: "My Projects",
      subtitle:
        "Here are some projects I built while learning and practicing frontend development.",
    ...
    footer: {
      ...
      worktogether: "Have a project in mind? Let's collaborate.",
    },
  },
  ...
  vi: {
    ...
    about: {
      ...
      highlights: {
        cleanCode: {
          title: "Code sạch",
          description: "Viết code dễ đọc và dễ bảo trì.",
        },
        fastLearner: {
          title: "Học nhanh",
        ...
        detail: {
          title: "Chú ý chi tiết",
          description: "Quan tâm đến từng chi tiết trong UI/UX.",
        },
      },
    },
    skills: {
      ...
      subtitle:
        "Các công nghệ và công cụ tôi sử dụng và cải thiện mỗi ngày để xây dựng sản phẩm tuyệt vời.",
      ...
      expertise: {
        learning: {
          title: "Học liên tục",
          description: "Luôn khám phá công nghệ mới và best practices.",
        },
        cleanCode: {
          title: "Tập trung clean code",
          description: "Viết code dễ bảo trì, dễ hiểu và có tài liệu rõ ràng.",
        },
        uiux: {
          title: "Tư duy UI/UX",
          description:
            "Chú ý chi tiết trong thiết kế và trải nghiệm người dùng.",
        },
        responsive: {
          title: "Thiết kế responsive",
          description: "Giao diện đẹp hoạt động tốt trên mọi thiết bị.",
        },
        performance: {
          title: "Tối ưu hiệu năng",
          description: "Tối ưu thời gian tải và đảm bảo trải nghiệm mượt mà.",
        },
        problem: {
          title: "Giải quyết vấn đề",
          description: "Xử lý thách thức phức tạp bằng giải pháp sáng tạo.",
        },
        debug: {
          title: "Kỹ năng debug",
          description: "Nhanh chóng tìm và sửa lỗi với công cụ hiện đại.",
        },
        collab: {
          title: "Làm việc nhóm",
          description: "Làm việc hiệu quả và giao tiếp kỹ thuật rõ ràng.",
        },
      },
    },
    projects: {
      ...
      subtitle:
        "Đây là một số dự án tôi đã xây dựng trong quá trình học và thực hành lập trình frontend.",
    ...
    contact: {
      ...
      heading2: "với tôi",
      subtitle:
        "Hãy liên hệ với tôi về công việc, hợp tác, hoặc chỉ là một cuộc trò chuyện thân thiện 👋",
      email: "Email",
      phone: "Điện thoại",
      location: "Địa điểm",
    ...
    footer: {
      description:
        "Lập trình viên Frontend tạo ra trải nghiệm web hiện đại, nhanh và đẹp.",
      Connect: "Kết nối",
      navigate: "Điều hướng",
      nav: {
        hero: "Trang chủ",
      ...
      work: "Làm việc cùng nhau",
      getinTouch: "Liên hệ",
      worktogether: "Có dự án trong đầu? Hãy hợp tác cùng nhau.",
    },
  },
} as const;
